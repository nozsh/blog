...
В правом верхнем углу страницы нажмите на иконку вашего профиля и выберите "Settings" (Настройки). Затем перейдите в раздел "Developer settings": в левой панели навигации прокрутите вниз и выберите "Developer settings".
...
![Генерация токенов](https://i.imgur.com/X3y7VEt.png)
