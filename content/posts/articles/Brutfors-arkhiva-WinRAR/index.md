...
date: 2024-05-15
tags: ["Batch", "Брутфорс", "WinRAR", "Windows"] # ['tag 1', 'tag 2']
...
UseHugoToc: true
cover:
  image: "Brutfors-arkhiva-WinRAR-Cover.jpg" # image path/url
...
И вызываем блок кода (подпрограмму) `call: :try`, который идет следующим:
...
Мы получаем, такой немного измененный блок кода:
