...
{{< imgs/imgc width="" caption="Ryujinx - Установка прошивки" alt="Ryujinx - Установка прошивки" src="004-ryujinx-ustanovka-proshivki.jpg" >}}
...
{{< imgs/imgc width="" caption="NSZ GUI - ERROR" alt="NSZ GUI - ERROR" src="005-Piratim-Nintendo-Switch-NSZ-GUI-ERROR.jpg" >}}
...
{{< imgs/imgc width="" caption="NSZ GUI" alt="NSZ GUI" src="006-piratim-nintendo-switch-NSZ-GUI.jpg" >}}
...
{{< imgs/imgc width="" caption="NSZ GUI & Prince of Persia: The Lost Crown" alt="NSZ GUI & Prince of Persia: The Lost Crown" src="007-piratim-nintendo-switch-NSZ-GUI-Prince-of-Persia-The-Lost-Crown.jpg" >}}
...
{{< imgs/imgc width="" caption="Ryujinx - Запуск игры" alt="Ryujinx - Запуск игры" src="008-piratim-nintendo-switch-Ryujinx-Zapusk-igry.jpg" >}}
...
{{< imgs/imgc width="" caption="Ryujinx - DLC" alt="Ryujinx - DLC" src="009-piratim-nintendo-switch-Ryujinx-DLC.jpg" >}}
...
{{< imgs/imgc width="" caption="Ryujinx - Настройки" alt="Ryujinx - Настройки" src="010-piratim-nintendo-switch-Ryujinx-Nastroiki.jpg" >}}
...
{{< imgs/imgc width="" caption="Ryujinx - Настройки ввода" alt="Ryujinx - Настройки ввода" src="011-piratim-nintendo-switch-Ryujinx-Nastroiki-vvoda.jpg" >}}
...
Для геймпада DualShock 4\5 (PlayStation) можно использовать [DS4Windows](https://github.com/Ryochan7/DS4Windows?nt).

{{< details/1 "Проблемы с DS4Windows" >}}
Из за ситуации с драйвером ([vigembus](https://github.com/nefarius/ViGEmBus?nt)) который использует DS4Windows, второй прекратит обновления. Если вы читаете эту статью из будущего, то возможно придется искать другой софт.
...
{{< imgs/imgc width="" caption="" alt="Ryujinx - Настройки ввода" src="012-piratim-nintendo-switch.jpg" >}}
...
{{< imgs/imgc width="" caption="" alt="Ryujinx - Настройки ввода" src="013-piratim-nintendo-switch.jpg" >}}
...
{{< imgs/imgc width="" caption="Ryujinx - Настройки графики" alt="Ryujinx - Настройки графики" src="014-piratim-nintendo-switch-Ryujinx-Nastroiki-grafiki.jpg" >}}

Для начала советую поставить что-то по типу этого:

{{< imgs/imgc width="" caption="Ryujinx - Настройки графики" alt="Ryujinx - Настройки графики" src="015-piratim-nintendo-switch-Ryujinx-Nastroiki-grafiki.jpg" >}}
