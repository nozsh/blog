...
# byai: true
cover:
  image: "stable-diffusion/stable-diffusion-cover.jpg" # image path/url
  alt: "Stable Diffusion - Cover" # alt text
  caption: "Cover-Image сгенерировано моделью - [Inkpunk Diffusion](https://civitai.com/models/1087/inkpunk-diffusion?nt)" # display caption under cover
...
Stable Diffusion это тип ИИ модели для генерации изображений. Так же существует одноименное ПО от [automatic1111](https://github.com/AUTOMATIC1111?nt).
...
[Выпуск Stable Diffusion](https://stability.ai/news/stable-diffusion-public-release?nt) стал важной вехой в этом развитии, поскольку высокопроизводительная модель оказалась доступной широкой публике (производительная с точки зрения качества изображения, скорости и относительно низких требований к ресурсам).

{{< details/1html "Пикчи" >}}
{{< imgs/gallerya "@img/pic-001-stable-diffusion-djz-ink-punk-v21-grid.jpg" "" "@img/pic-002-stable-diffusion-inkpunk-diffusion-v2-grid.jpg" "" "@img/pic-003-stable-diffusion-djz-dieselpunk-city-v21-grid.jpg" "" "@img/pic-004-stable-diffusion-djz-dieselpunk-city-v21.jpg" "big" "@img/pic-005-stable-diffusion-umiaimythologyandbabes.jpg" "big" "@img/pic-006-stable-diffusion-umiaimythologyandbabes.jpg" "" "@img/pic-008-stable-diffusion-umiaimythologyandbabes.jpg" "" "@img/pic-009-stable-diffusion-umiaimythologyandbabes.jpg" "" "@img/pic-010-stable-diffusion-umiaimythologyandbabes.jpg" "" "@img/pic-011-stable-diffusion-umiaimythologyandbabes.jpg" "" >}}

<p><b>Модели:</b></p>

<ul>
<li>
<a href="https://civitai.com/models/4003/djz-ink-punk-v21?nt">djz Ink Punk V21</a>
</li>
<li>
<a href="https://civitai.com/models/3985/djz-dieselpunk-city-v21?nt">djz Dieselpunk City V21</a>
</li>
<li>
<a href="https://civitai.com/models/1087/inkpunk-diffusion?nt">Inkpunk Diffusion</a>
</li>
<li>
<a href="https://civitai.com/models/6077/umi-ai-mythology-and-babes-by-dutchalex?nt">Umi AI Mythology and Babes by DutchAlex</a>
</li>
</ul>
{{< /details/1html >}}
...
![Stable Diffusion - Как работает Stable Diffusion (1)](001-stable-diffusion-kak-rabotayet-stable-diffusion.jpg)
...
![Stable Diffusion - Как работает Stable Diffusion (2)](002-stable-diffusion-kak-rabotayet-stable-diffusion.jpg)
...
![Stable Diffusion - Компоненты Stable Diffusion (1)](003-stable-diffusion-komponenty-stable-diffusion.jpg)
...
![Stable Diffusion - Компоненты Stable Diffusion (2)](004-stable-diffusion-komponenty-stable-diffusion.jpg)
...
![Stable Diffusion -  Создание информации изображения](005-stable-diffusion-sozdaniye-informatsii-izobrazheniya.jpg)
...
![Stable Diffusion -  Декодер изображений](006-stable-diffusion-diffusion-dekoder-izobrazheniy.jpg)
...
![Stable Diffusion - Декодер изображений](007-stable-diffusion-diffusion-dekoder-izobrazheniy.jpg)
...
![Stable Diffusion - Что такое диффузия](008-stable-diffusion-diffusion-chto-takoye-diffuziya.jpg)
...
![Stable Diffusion - Что такое диффузия](009-stable-diffusion-diffusion-chto-takoye-diffuziya.jpg)
...
![Stable Diffusion - Что такое диффузия](010-stable-diffusion-diffusion-chto-takoye-diffuziya.jpg)

Мы можем визуализировать набор таких latent, чтобы увидеть, какая информация добавляется на каждом из шагов.

![Stable Diffusion - Что такое диффузия](011-stable-diffusion-diffusion-chto-takoye-diffuziya.jpg)
...
{{< iframes/yt obYWByf40OQ "stable diffusion steps 2 4" >}}
...
![Stable Diffusion - Как работает диффузия](012-stable-diffusion-diffusion-kak-rabotayet-diffuziya.jpg)
...
![Stable Diffusion - Как работает диффузия](013-stable-diffusion-diffusion-kak-rabotayet-diffuziya.jpg)
...
![Stable Diffusion - Как работает диффузия](014-stable-diffusion-diffusion-kak-rabotayet-diffuziya.jpg)
...
![Stable Diffusion - Как работает диффузия](015-stable-diffusion-diffusion-kak-rabotayet-diffuziya.jpg)
...
![Stable Diffusion - Рисование изображений устранением шума](016-stable-diffusion-diffusion-risovaniye-izobrazheniy-ustraneniyem-shuma.jpg)
...
![Stable Diffusion - Рисование изображений устранением шума](017-stable-diffusion-diffusion-risovaniye-izobrazheniy-ustraneniyem-shuma.jpg)

Если обучающий массив данных состоял из эстетически приятных изображений (например, [LAION Aesthetics](https://laion.ai/blog/laion-aesthetics/?nt), на котором обучалась Stable Diffusion), то получившееся изображение будет иметь склонность к эстетической приятности.

![Stable Diffusion - Рисование изображений устранением шума](018-stable-diffusion-diffusion-risovaniye-izobrazheniy-ustraneniyem-shuma.jpg)

В этом по большей мере и заключается описание генерации изображений диффузионными моделями, представленное в статье [Denoising Diffusion Probabilistic Models](https://arxiv.org/abs/2006.11239?nt). Теперь, когда мы понимаем, что такое диффузия, нам понятно, как работают основные компоненты не только Stable Diffusion, но и Dall-E 2 с Google Imagen.
...
Для ускорения процесса генерации изображений Stable Diffusion (по информации из исследовательской статьи) выполняет процесс диффузии не с самими пиксельными изображениями, а со сжатой версией изображения. В [статье](https://arxiv.org/abs/2112.10752?nt) это называется «переходом в скрытое пространство».
...
![Stable Diffusion - Увеличение скорости: диффузия сжатых (скрытых) данных, а не пиксельного изображения](019-stable-diffusion-uvelicheniye-skorosti-diffuziya-szhatykh-(skrytykh)-dannykh-a-ne-pikselnogo-izobrazheniya.jpg)
...
![Stable Diffusion - Увеличение скорости: диффузия сжатых (скрытых) данных, а не пиксельного изображения](020-stable-diffusion-uvelicheniye-skorosti-diffuziya-szhatykh-(skrytykh)-dannykh-a-ne-pikselnogo-izobrazheniya.jpg)
...
![Stable Diffusion - Увеличение скорости: диффузия сжатых (скрытых) данных, а не пиксельного изображения](021-stable-diffusion-uvelicheniye-skorosti-diffuziya-szhatykh-(skrytykh)-dannykh-a-ne-pikselnogo-izobrazheniya.jpg)

Эти два потока показаны на рисунке статьи про LDM/Stable Diffusion:

![Stable Diffusion - Увеличение скорости: диффузия сжатых (скрытых) данных, а не пиксельного изображения](022-stable-diffusion-uvelicheniye-skorosti-diffuziya-szhatykh-(skrytykh)-dannykh-a-ne-pikselnogo-izobrazheniya.jpg)
...
Языковая модель Transformer используется в качестве компонента понимания языка, она получает текстовую строку и создает эмбеддинги токенов. В опубликованной модели Stable Diffusion используется ClipText ([модель на основе GPT](https://jalammar.github.io/illustrated-gpt2/?nt)), а в статье применяется [BERT](https://jalammar.github.io/illustrated-bert/?nt).
...
{{< imgs/imgc width="" caption="Улучшение/увеличение языковых моделей существенно влияет на качество моделей генерации изображений.<br>Источник: <a href='https://arxiv.org/abs/2205.11487?nt'>Статья про Google Imagen, написанная Saharia и соавторами.</a>" alt="Текстовый кодировщик: языковая модель Transformer (1)" src="023-stable-diffusion-tekstovyy-kodirovshchik-yazykovaya-model-transformer.jpg" >}}

В первых моделях Stable Diffusion просто подключалась предварительно обученная модель ClipText, выпущенная OpenAI. Возможно, будущие модели перейдут на новые и гораздо более объемные [OpenCLIP](https://laion.ai/blog/large-openclip/?nt)-варианты CLIP. В эту новую группу входных векторов включены текстовые модели размерами до 354 миллионов параметров, в отличие от 63 миллионов параметров в ClipText.
...
![Stable Diffusion - Как обучается CLIP](024-stable-diffusion-kak-obuchayetsya-CLIP.jpg)
...
![Stable Diffusion - Как обучается CLIP](025-stable-diffusion-kak-obuchayetsya-CLIP.jpg)
...
![Stable Diffusion - Как обучается CLIP](026-stable-diffusion-kak-obuchayetsya-CLIP.jpg)

Мы обновляем две модели так, чтобы в следующий раз при создании эмбеддингов получившиеся эмбеддинги были схожими.

![Stable Diffusion - Как обучается CLIP](027-stable-diffusion-kak-obuchayetsya-CLIP.jpg)

Повторяя этот процесс со всем массивом данных и группами входных векторов большого размера, мы получаем кодировщики, способные создавать эмбеддинги, в которых изображение собаки и предложение «a picture of a dog» схожи. Как и в [word2vec](https://jalammar.github.io/illustrated-word2vec/?nt), процесс обучения также должен включать в себя **отрицательные примеры** изображений и подписей, которые не совпадают, а модель должна присваивать им низкую оценку схожести.
...
![Stable Diffusion - Передача текстовой информации в процесс генерации изображений](028-stable-diffusion-peredacha-tekstovoy-informatsii-v-protsess-generatsii-izobrazheniy.jpg)
...
![Stable Diffusion - Передача текстовой информации в процесс генерации изображений](029-stable-diffusion-peredacha-tekstovoy-informatsii-v-protsess-generatsii-izobrazheniy.jpg)
...
![Stable Diffusion - Слои предсказателя шума Unet (без текста)](030-stable-diffusion-sloi-predskazatelya-shuma-unet-bez-teksta.jpg)
...
![Stable Diffusion - Слои предсказателя шума Unet (без текста)](031-stable-diffusion-sloi-predskazatelya-shuma-unet-bez-teksta.jpg)

##### Слои предсказателя шума Unet с текстом

Давайте посмотрим, как изменить эту систему, чтобы уделить внимание тексту.

![Stable Diffusion - Слои предсказателя шума Unet с текстом](032-stable-diffusion-sloi-predskazatelya-shuma-unet-s-tekstom.jpg)
...
![Stable Diffusion - Слои предсказателя шума Unet с текстом](033-stable-diffusion-sloi-predskazatelya-shuma-unet-s-tekstom.jpg)
...
- [Stable Diffusion with 🧨 Diffusers](https://huggingface.co/blog/stable_diffusion?nt)
- [The Annotated Diffusion Model](https://huggingface.co/blog/annotated-diffusion?nt)
- [How does Stable Diffusion work? – Latent Diffusion Models EXPLAINED](https://www.youtube.com/watch?v=J87hffSMB60?nt) (Видео)
- [Stable Diffusion - What, Why, How?](https://www.youtube.com/watch?v=ltLNYA3lWAQ?nt) (Видео)
- [High-Resolution Image Synthesis with Latent Diffusion Models](https://ommer-lab.com/research/latent-diffusion-models/?nt) (Статья про Stable Diffusion)
- Более подробное изучение алгоритмов и математики представлено в статье Лилиан Венг (Lilian Weng) [What are Diffusion Models?](https://lilianweng.github.io/posts/2021-07-11-diffusion-models/?nt)
- [Одноминутный клип на YouTube](https://youtube.com/shorts/qL6mKRyjK-0?nt) по использованию [Dream Studio](https://beta.dreamstudio.ai/?nt) для генерации изображений при помощи Stable Diffusion.
- Хорошие [видео](https://www.youtube.com/playlist?list=PLfYUBJiXbdtRUvTUYpLdfHHp9a58nWVXP?nt) о Stable Diffusion от fast.ai

Источник - перевод «[The Illustrated Stable Diffusion](https://jalammar.github.io/illustrated-stable-diffusion/?nt)»
...
Насчет процессора как таковой информации нету. Но при желании Stable Diffusion можно запустить и на 4VRAM. Используя облегченные форки например от [basujindal](https://github.com/basujindal/stable-diffusion?nt).

Так же стоит предупредить что [официальная установка Stable Diffusion](https://github.com/CompVis/stable-diffusion?nt) и правда требует минимум 10VRAM и 16RAM.

Как нынче все что можно запустить в этом мире, моя рекомендация запускать конечно же на SSD.

Мы будем использовать вариант от [AUTOMATIC1111](https://github.com/AUTOMATIC1111?nt), простой, удобный и не слишком требовательный.
...
Далее переходим на [HuggingFace](https://huggingface.co/stabilityai/stable-diffusion-2-1?nt). Там вам нужно будет скачать саму модель в формате ckpt или safetensors, не имеет значения в каком.
...
Сравнение можно посмотреть [здесь](https://huggingface.co/stabilityai/stable-diffusion-2/discussions/22?nt).
{{< /details/1 >}}

Далее скачайте [v2-inference-v.yaml](https://github.com/Stability-AI/stablediffusion/tree/main/configs/stable-diffusion?nt).

{{< iframes/yt e3vcYVwEkW0 "NEW Stable Diffusion 2.1 Tutorial - easy setup + what you need to know" "?start=124" >}}

И так что мы имеем?

- Вы установили Python, и если вы введете в консоль `python -V` или `python3 -V`, вы должны увидеть версию питона, указанную выше или в [репозитории на GitHub](https://github.com/AUTOMATIC1111/stable-diffusion-webui#user-content-automatic-installation-on-windows?nt).
...
Для использования понадобится указать `--xformers` в параметрах запуска. А так же скачать и установить [CUDA 11.3](https://developer.nvidia.com/cuda-11.3.0-download-archive?nt) (какую версию CUDA смотреть [здесь](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Xformers#user-content-building-xformers-on-windows-by-duckness?nt)), выбрать Custom, а далее выбрать только следующее:

![Установка Stable Diffusion локально - CUDA](034-stable-diffusion-xformers-installer.jpg)
...
Подробнее [здесь](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Xformers?nt).
...
Из-за параметров **share** и **listen** могу не работать некоторые расширения, которые скорее всего еще не установлены, но которые вы возможно захотите установить, например [ControlNet](https://huggingface.co/lllyasviel/ControlNet?nt) (у меня так).
...
Подробнее [здесь](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Optimizations?nt).
